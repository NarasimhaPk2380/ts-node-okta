...
var DbTestService = /** @class */ (function () {
    function DbTestService() {
        this.mongod = mongodb_memory_server_1.MongoMemoryServer.create();
    }
    DbTestService.prototype.connect = function () {
        return __awaiter(this, void 0, void 0, function () {
            var uri, mongooseOpts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.mongod];
                    case 1:
                        uri = (_a.sent()).getUri();
                        mongooseOpts = {
    ...
    DbTestService.prototype.disconnect = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    DbTestService.prototype.deleteDatabase = function () {
        return __awaiter(this, void 0, void 0, function () {
