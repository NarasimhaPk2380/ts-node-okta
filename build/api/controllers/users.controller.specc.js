...
describe("UsersController", function () {
    ...
    var instanceOfOktaClientServiceMock = new OktaClientServiceMock(mocking_funtions_2.oktaClient, mocking_funtions_2.oktaAuthClient);
    mocking_funtions_1.createMocks(instanceOfOktaClientServiceMock, availableMethodsInOktaClientSrvc);
    beforeEach(function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, usersController.registerOktaUser(mockRequest, res, mocking_funtions_1.mockNext)];
                case 1:
                    _a.sent();
    ...
    it("Should login user", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    res = mocking_funtions_1.mockResponse();
                    return [4 /*yield*/, usersController.loginOktaUser(mockRequest, res, mocking_funtions_1.mockNext)];
                case 1:
                    _a.sent();
                    expect(res.status).toHaveBeenCalledWith(200);
                    expect(res.json).toHaveBeenCalledWith(availableMethodsInOktaClientSrvc.sessionLogin);
                    return [2 /*return*/];
            }
        });
    }); });
