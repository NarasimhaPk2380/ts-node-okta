    ...
    describe("Books CRUD Operations", function () {
                ...
                switch (_a.label) {
                    case 0:
                        books_model_1.default.prototype.save = jest
                            .fn()
                            .mockResolvedValueOnce(__assign(__assign({}, bookData), { _id: "123" }));
                        return [4 /*yield*/, booksService.createBook(bookData)];
                    case 1:
                        response = _a.sent();
        ...
        it("Should get a book details", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        books_model_1.default.findById = jest.fn().mockResolvedValueOnce(__assign({}, bookData));
                ...
                switch (_a.label) {
                    case 0:
                        books_model_1.default.findByIdAndUpdate = jest
                            .fn()
                            .mockResolvedValueOnce(__assign(__assign({}, bookData), { name: "durga" }));
                        return [4 /*yield*/, booksService.updateBook("123", bookData)];
                    case 1:
                        response = _a.sent();
        ...
        it("Should delete a book", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        books_model_1.default.findByIdAndDelete = jest.fn().mockResolvedValueOnce(__assign({}, bookData));
    ...
    describe("Revies CRUD Operations", function () {
        ...
        it("Should create a review", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        books_model_1.default.findById = jest.fn().mockResolvedValueOnce(__assign(__assign({}, bookData), { save: jest.fn().mockResolvedValueOnce(__assign({}, bookData)) }));
                        review_model_1.default.prototype.save = jest
                            .fn()
                            .mockResolvedValueOnce(__assign(__assign({}, reviewData), { _id: "123" }));
                        return [4 /*yield*/, booksService.createBookReview("123", reviewData)];
                    case 1:
                        response = _b.sent();
        ...
        it("Should get a book review", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        review_model_1.default.findById = jest.fn().mockResolvedValueOnce(reviewData);
                ...
                switch (_a.label) {
                    case 0:
                        review_model_1.default.findByIdAndUpdate = jest
                            .fn()
                            .mockResolvedValueOnce(__assign(__assign({}, reviewData), { reviewer: "durga" }));
                        return [4 /*yield*/, booksService.updateBookReview("123", "231", reviewData)];
                    case 1:
                        response = _a.sent();
                ...
                switch (_a.label) {
                    case 0:
                        review_model_1.default.findByIdAndDelete = jest
                            .fn()
                            .mockResolvedValueOnce(__assign({}, reviewData));
    ...
    describe("Books CRUD Operations", function () {
        it("Should fail to retreieve all books", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        books_model_1.default.find = jest.fn().mockImplementationOnce(function () { return ({
                            populate: jest.fn().mockRejectedValue("Failed to retrieve all books"),
                        }); });
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 3:
                        e_2 = _a.sent();
                        expect(e_2).toBe("Failed to retrieve all books");
                        return [3 /*break*/, 4];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        books_model_1.default.prototype.save = jest
                            .fn()
                            .mockRejectedValueOnce("Failed to create a book");
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, booksService.createBook(bookData)];
                    ...
                    case 3:
                        e_3 = _a.sent();
                        expect(e_3).toBe("Failed to create a book");
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
                }
            });
        ...
        it("Should fail to get a book details", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        books_model_1.default.findById = jest
                            .fn()
                            .mockRejectedValueOnce("Failed to retrieve book details");
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, booksService.getBookDetails("123")];
                    ...
                    case 3:
                        e_4 = _a.sent();
                        expect(e_4).toBe("Failed to retrieve book details");
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        books_model_1.default.findByIdAndUpdate = jest
                            .fn()
                            .mockRejectedValueOnce("Failed to update a book");
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, booksService.updateBook("123", bookData)];
                    ...
                    case 3:
                        e_5 = _a.sent();
                        expect(e_5).toBe("Failed to update a book");
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
                }
            });
        ...
        it("Should fail to delete a book", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        books_model_1.default.findByIdAndDelete = jest
                            .fn()
                            .mockRejectedValueOnce("Failed to delete a book");
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, booksService.deleteBook("123")];
                    ...
                    case 3:
                        e_6 = _a.sent();
                        expect(e_6).toEqual("Failed to delete a book");
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
                }
            });
    ...
    describe("Revies CRUD Operations", function () {
                ...
                switch (_a.label) {
                    case 0:
                        books_model_1.default.findById = jest.fn().mockImplementationOnce(function () { return ({
                            populate: jest
                                .fn()
                                .mockRejectedValueOnce("Failed to retrieve all reviews"),
                        }); });
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 3:
                        e_7 = _a.sent();
                        expect(e_7).toEqual("Failed to retrieve all reviews");
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
                }
            });
        ...
        it("Should fail to create a review", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        books_model_1.default.findById = jest.fn().mockRejectedValueOnce(__assign(__assign({}, bookData), { save: jest
                                .fn()
                                .mockRejectedValueOnce("Failed to create a book review") }));
                        return [4 /*yield*/, booksService.createBookReview("123", reviewData)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
        ...
        it("Should fail to get a book review", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        review_model_1.default.findById = jest
                            .fn()
                            .mockRejectedValueOnce("Failed to get a book review");
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, booksService.getBookReview("1")];
                    ...
                    case 3:
                        e_9 = _a.sent();
                        expect(e_9).toEqual("Failed to get a book review");
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        review_model_1.default.findByIdAndUpdate = jest
                            .fn()
                            .mockRejectedValueOnce("Failed to update a book review");
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, booksService.updateBookReview("123", "231", reviewData)];
                    ...
                    case 3:
                        e_10 = _a.sent();
                        expect(e_10).toBe("Failed to update a book review");
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        review_model_1.default.findByIdAndDelete = jest
                            .fn()
                            .mockRejectedValueOnce("Failed to delete a book review");
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, booksService.deleteBookReview("123", "231")];
                    ...
                    case 3:
                        e_11 = _a.sent();
                        expect(e_11).toEqual("Failed to delete a book review");
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
                }
            });
