...
describe("Book Model Test", function () {
    ...
    it("Create & save user successfully", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    book = new books_model_1.default(mock_data_1.bookData);
                    return [4 /*yield*/, book.save()];
                case 1:
                    savedUser = _a.sent();
                    expect(savedUser._id).toBeDefined();
                    expect(savedUser.name).toBe(mock_data_1.bookData.name);
                    expect(savedUser.author.length).toBe(mock_data_1.bookData.author.length);
                    expect(savedUser.publisher).toEqual(mock_data_1.bookData.publisher);
                    expect(savedUser.price).toEqual(mock_data_1.bookData.price);
                    return [2 /*return*/];
            }
        });
    }); });
    it("Throw error when any one of the field is empty", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    book = new books_model_1.default({
                        name: "TekLoon",
                    });
                    _a.label = 1;
                case 1:
                ...
                case 3:
                    e_1 = _a.sent();
                    expect(e_1.message).toContain("publisher location is required");
                    expect(e_1.message).toContain("publisher name is required");
                    expect(e_1.message).toContain("publisher_id is required");
                    expect(e_1.message).toContain("Price is required");
                    return [3 /*break*/, 4];
